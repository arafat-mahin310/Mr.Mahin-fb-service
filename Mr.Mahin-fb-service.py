...
{W}❲☆❳Telegram : {rgb}https://t.me/arafatmahin310
{W}❲☆❳Youtube  : {rgb}https://youtube.com/@ugly_man
{ab}❲☆❳────────────────────────────────────────────────""")
...
def cblg():
    ...
    if lg == "y" or lg == "Y":
       os.system("python Zking-bot.cpython-311.pyc")
    elif lg == "n" or lg == "N":
...
def spam_shear():
       ...
       try:
          ...
          if "," in text:
             ...
             text=('Love You Arafat Bin Mahin 😍\n\n')+text
          print(f"{ab}❲☆❳────────────────────────────────────────────────")
          with ThreadPoolExecutor(max_workers=20) as ex:
               for i in range(jum):
